...
// app.get("/resume-present/:id", async (req, res) => {
//   const id = req.params.id;
//   try {
...
//   //upload the resume in cloudinary and save the link in the database
// });
...
//       existingApplication.internId.push(internId);
...
//     // Add clerkId to internship.selectedPeople
...
app.post("/add-resume", upload.single("resume"), async (req, res) => {
