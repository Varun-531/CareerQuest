...
//             <SheetContent>
//               <SheetHeader>
//                 <SheetTitle>Your Applications</SheetTitle>
//                 {isSignedIn ? (
//                   <SheetDescription>
//                     You have 3 new applications{" "}
//                     {isLoaded && isSignedIn && (
...
//                   </SheetDescription>
//                 ) : (
//                   <SheetDescription>Sign in</SheetDescription>
//                 )}
//               </SheetHeader>
//               {isLoaded && isSignedIn && <h1>{resumePresent}</h1>}
//             </SheetContent>
//           </Sheet>
//         </div>
//         {isSignedIn ? (
...
const Header = () => {
  ...
  const handleSubmitResume = () => {
    ...
    axios
      .post(`http://localhost:4000/add-resume`, formData, {
        headers: {
        ...
        <div>
          <Sheet>
            ...
            <SheetContent>
              ...
              {isLoaded && isSignedIn && (
                <>
                  <h1>{resumePresent ? "Resume found" : "No resume found"}</h1>
                  <Label>Resume</Label>
                  <Input
                    type="file"
                    value={inputResume}
                  ...
                  />
                  <Button className="mt-2" onClick={handleSubmitResume}>
                    Upload
                  </Button>
                </>
              )}
